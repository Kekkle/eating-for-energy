const questions = {
  ...
  bloodSugar: [
    ...
    {
      type: 'fill-in-blank',
      question: 'Fill in the correct words:',
      template: 'Eating something sweet |BLANK| a balanced meal, when your stomach is |BLANK|, slows the absorption of |BLANK| into your blood and helps avoid the blood sugar |BLANK|.',
      words: ['after', 'full', 'glucose', 'roller coaster'],
      distractors: ['before', 'empty', 'protein', 'highway'],
      explanation: 'Eating sweets after a balanced meal, when your stomach is full, slows glucose absorption and prevents the blood sugar roller coaster.',
      difficulty: 1,
    },
  ],
  ...
  healthyHabits: [
    ...
    },
    {
      ...
      options: ['10g per 100g', '5g per 100g', '2g per 100g', '20g per 100g'],
      answer: 0,
...
export function getQuestionsForTopic(topicId) {
  if (topicId === 'fullChallenge') {
    return [
      ...questions.macronutrients,
      ...questions.bloodSugar,
      ...questions.healthyHabits,
    ]
  }
