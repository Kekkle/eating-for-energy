...
function getMessage(percentage) {
  if (percentage >= 0.85) return "Amazing! You're a hydration hero! 💧🌟"
  if (percentage >= 0.7) return "Great work! You really know your hydration facts! 💪"
  if (percentage >= 0.5) return "Good effort! You're on your way to becoming a hydration expert! 🚀"
