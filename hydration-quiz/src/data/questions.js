...
const games = [
  ...
  },
  {
    ...
    instruction: 'Sort these foods into the correct category.',
    categories: [
      {
        name: 'Hydrating',
        items: [
    ...
    explanation:
      'Fruits and vegetables have high water content and are hydrating for the body. Cucumber, celery, and tomatoes are about 98% water! Watermelon and soup are also great sources.',
    difficulty: 1,
  },
  {
    type: 'emoji-select',
    ...
    options: [
      { name: 'Very light', emoji: '💛' },
      { name: 'Light', emoji: '💛' },
      { name: 'Pale', emoji: '💛' },
      { name: 'Medium', emoji: '🟡' },
      { name: 'Dark', emoji: '🟡' },
      { name: 'Very dark', emoji: '🟠' },
    ],
    answers: [0, 1, 2],
    explanation:
