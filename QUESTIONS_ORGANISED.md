# Quiz Questions -- Organised by Topic

All questions from your reviewed file, reorganised into 3 clear topics. Numbering is fresh. Review and approve.
...
- Sort = Sorting game
- Create = Build/create activity

---
---

## Topic 1: Macronutrients & Balanced Eating (13 questions)

_What are macronutrients, what do they do, and how do we eat well?_
...
### 1.3 (Sort, Difficulty: 1)

**Question:** Sort the macronutrients into the correct boxes.

_Note to agent: We will use the "Sort the macronutrient" game from the Nutrition App folder._

---

### 1.4 (T/F, Difficulty: 1)
...
## Topic 2: Blood Sugar & Energy (9 questions)

_How does blood sugar work, what controls it, and how does it affect our energy?_
...
### 3.1 (DnD, Difficulty: 1) — Carb Swaps
...
### 3.2 (Create, Difficulty: 1) — Create a Drink
